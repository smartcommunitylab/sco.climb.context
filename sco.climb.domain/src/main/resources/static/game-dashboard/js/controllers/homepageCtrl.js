...
angular.module('climbGame.controllers.homepage', [])
  .controller('homepageCtrl', ['$scope', '$state','profileService', 'dataService', 'CacheSrv', 'loginService', 'configService', 'mapService', '$mdDialog',
    function ($scope, $state, profileService, dataService, CacheSrv, loginService,configService, mapService, $mdDialog,) {
